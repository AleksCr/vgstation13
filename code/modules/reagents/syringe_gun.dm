				...
				for(var/mob/living/carbon/M in D.loc)
					...
					if(D.reagents)
						for(var/datum/reagent/A in D.reagents.reagent_list)
							...
							R += num2text(A.volume) + "),"
					if (istype(M, /mob))
						M.add_attack_log("\[[time_stamp()]\] <b>[user]/[user.ckey]</b> shot <b>[M]/[M.ckey]</b> with a <b>syringegun</b> ([R]) [blocked ? "\[BLOCKED\]" : ""]")
						user.add_attack_log("\[[time_stamp()]\] <b>[user]/[user.ckey]</b> shot <b>[M]/[M.ckey]</b> with a <b>syringegun</b> ([R]) [blocked ? "\[BLOCKED\]" : ""]")
						...
						M.add_attack_log("\[[time_stamp()]\] <b>UNKNOWN SUBJECT (No longer exists)</b> shot <b>[M]/[M.ckey]</b> with a <b>syringegun</b> ([R]) [blocked ? "\[BLOCKED\]" : ""]")
