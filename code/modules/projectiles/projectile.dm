...
/obj/item/projectile/proc/admin_warn(mob/living/M)
	if(istype(firer, /mob))
		if(firer == M)
			...
			M.add_attack_log("\[[time_stamp()]\] <b>[key_name(firer)]</b> shot himself with a <b>[type]</b>")
			firer.add_attack_log("\[[time_stamp()]\] <b>[key_name(firer)]</b> shot himself with a <b>[type]</b>")
			...
			M.add_attack_log("\[[time_stamp()]\] <b>[key_name(firer)]</b> shot <b>[key_name(M)]</b> with a <b>[type]</b>")
			firer.add_attack_log("\[[time_stamp()]\] <b>[key_name(firer)]</b> shot <b>[key_name(M)]</b> with a <b>[type]</b>")
		...
		M.add_attack_log("\[[time_stamp()]\] <b>UNKNOWN/(no longer exists)</b> shot <b>UNKNOWN/(no longer exists)</b> with a <b>[type]</b>")
