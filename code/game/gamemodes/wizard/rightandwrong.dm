...
/mob/proc/rightandwrong(var/summon_type) //0 = Summon Guns, 1 = Summon Magic
	...
	for(var/mob/living/carbon/human/H in player_list)
		...
		if(prob(35) && !(H.mind in ticker.mode.traitors))
			...
			H.add_attack_log("\[[time_stamp()]\] <font color='red'>Was made into a survivor, and trusts no one!</font>")
		...
		var/randomizemagic = pick("fireball","smoke","blind","mindswap","forcewall","knock","horsemask","blink","subjugate","staffchange","armor","scrying")
		if(!summon_type)
